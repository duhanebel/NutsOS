...
#define NUTSOS_PROGRAM_VIRTUAL_STACK_ADDRESS_END   (NUTSOS_PROGRAM_VIRTUAL_STACK_ADDRESS_START - NUTSOS_USER_PROGRAM_STACK_SIZE) // stack grows downwards
...
#define NUTSOS_GDT_PRIVILEGE_RING_0                0
#define NUTSOS_GDT_PRIVILEGE_RING_3                3
#endif